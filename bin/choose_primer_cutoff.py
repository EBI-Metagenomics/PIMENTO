...
def choose_cutoff_for_single_strand(
    ...
    for start in cutoff_list:  # Looping through the pre-inflection point mcps
        substring_len = start + 4  # length of pre-inf mcps is inflection point + 4
    ...
    for i, end in enumerate(
        ...
        substring_len = end + 5  # length of pre-inf mcps is inflection point + 5
