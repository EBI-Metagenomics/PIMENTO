...
def choose_cutoff_for_single_strand(
    ...
    :param cutoff_list: List of inflection points generated by find_bcv_inflection_points().
    :type cutoff_list: list[int]
    ...
    :type rev: bool
    :return: Tuple containing the chosen cutoff point and consensus sequence of the predicted primer.
    :rtype: tuple[int, str]
    """
